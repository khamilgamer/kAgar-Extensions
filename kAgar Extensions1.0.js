...
setTimeout(function() {
    ...
    $( "#canvas" ).after( "<div style='background-color: #00FFC5; -moz-opacity: 0.4; -khtml-opacity: 0.4; opacity: 0.4; filter: alpha(opacity=40); zoom: 1; width: 205px; top: 10px; left: 10px; display: block; position: absolute; text-align: center; font-size: 15px; color: #D322DB; padding: 5px; font-family: Ubuntu;'> <div style='color:#D322DB; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><a>??kBot??</a></div> <div style='color:#D322DB; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><br>??Bot Status: <a id='minionCount' >Waiting...</a> </div> <div style='color:#D322DB; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><br>??Move to my mouse: <a id='ismoveToMouse' >On</a> </div> <div style='color:#D322DB; display: inline; -moz-opacity:1; -khtml-opacity: 1; opacity:1; filter:alpha(opacity=100); padding: 10px;'><br>??Stop your cell: <a id='isStopMove' >Off</a> </div>" );
